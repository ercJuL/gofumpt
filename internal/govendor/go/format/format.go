...
const (
	...
	//
	// This value is defined in github.com/ercJuL/gofumpt/internal/govendor/go/printer specifically for github.com/ercJuL/gofumpt/internal/govendor/go/format and cmd/gofmt.
